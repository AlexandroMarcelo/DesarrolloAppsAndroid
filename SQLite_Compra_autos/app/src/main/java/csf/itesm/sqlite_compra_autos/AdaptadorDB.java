...
public class AdaptadorDB {
    ...
    public long insertaClientes(String nombre, String email, String contrasenia)
    {
    ...
    public long insertaAutos(String marca, String nombre, String precio)
    {
        ContentValues initialValues = new ContentValues();
    ...
    public long insertaClientesCompraAutos(Integer id_cliente, Integer id_auto)
    {
        ContentValues initialValues = new ContentValues();
    ...
    public boolean borraAuto(long idFila)
    {
        return db.delete(AUTOS_TABLA, LLAVE_ID_AUTO + "=" + idFila, null) > 0;
    }

    //--- Borra un auto en particular ---
    public boolean borraClientesCompraAutos(long idFila)
    {
    ...
    public Cursor obtenTodosLosAutos()
    {
    ...
    public Cursor obtenTodosLosClientesCompraAutos()
    {
    ...
    public Cursor obtieneUnaCompra(long idFila) throws SQLException
    {
        Cursor mCursor =
    ...
    public boolean actualizaCliente(long idFila, String nombre, String email, String contrasenia)
    {
